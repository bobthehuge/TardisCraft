...
import net.bobthehuge.tardiscraft.generators.ReliefIslandGenerator;
...
public class ReliefIslandCommand extends Command {
    private static final String COMMAND_PERM_STRING = "tardiscraft.island";
    private static final Random RANDOM = new Random();

    public ReliefIslandCommand() {
        super("reliefisland", "Generates an island with relief", "/reliefisland <r>", List.of("ris"));
    }
    ...
    public boolean execute(@NotNull CommandSender commandSender, @NotNull String s, @NotNull String[] args) {
        ...
        try {
            ...
            Generator gen = new ReliefIslandGenerator(radius, RANDOM.nextInt(), 0.065);
